    ...
    <main className="flex h-[calc(100vh-90px)] flex-col items-center justify-between mt-[-55px] md:mt-[-55px] px-10 py-10 md:p-24">
      <div>
        <TitlePage
          ...
          urlExampleGitHub="https://github.com/ahmetizgi84/nextjs-v14-app-router-fetching-poc/blob/development/app/(pages)/ssg/page.tsx#L6-L9"
          underlineColor="border-orange-500 border-b-4"
          underlineWidth="w-[130px] md:w-[280px]"
        />

        <ListOfProducts products={products} color="text-orange-500" clickable />
      </div>
    </main>
  );
}
